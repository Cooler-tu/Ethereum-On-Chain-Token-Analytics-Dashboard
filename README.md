...
| Test automation | Local regression suite exists (149 passed, 1 skipped on 2026-08-30); GitHub Actions does not yet run it automatically |
...
| 测试未接入 CI | 本地回归测试已存在（2026-08-30：149 passed、1 skipped），GitHub Actions 尚未自动运行 |
