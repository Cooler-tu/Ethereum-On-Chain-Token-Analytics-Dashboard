...
def _analysis_series_schema(pa):
    return pa.schema(
        [
            ...
            pa.field("gross_lp_activity_token", pa.float64(), nullable=True),
            pa.field("recycling_share", pa.float64(), nullable=True),
            ...
            pa.field("actual_transfer_in_token", pa.float64(), nullable=False),
            pa.field("actual_transfer_out_token", pa.float64(), nullable=False),
            pa.field("actual_transfer_net_token", pa.float64(), nullable=False),
            pa.field("pool_transfer_event_count", pa.int64(), nullable=False),
            ...
            pa.field("gross_lp_activity_ratio", pa.float64(), nullable=True),
            pa.field("actual_transfer_net_ratio", pa.float64(), nullable=True),
...
def _normalize_analysis_series_row(row: dict[str, Any]) -> dict[str, Any]:
    ...
    optional_floats = (
        ...
        "gross_lp_activity_token", "recycling_share",
        "lp_identity_coverage", "liquidity_add_amount_coverage",
        "withdrawal_amount_coverage", "price_return",
        "tvl_change", "net_lp_flow_ratio", "gross_lp_activity_ratio",
        "actual_transfer_net_ratio", "withdrawal_ratio",
    ...
    normalized = {
        ...
        "actual_transfer_in_token": float(row.get("actual_transfer_in_token") or 0),
        "actual_transfer_out_token": float(row.get("actual_transfer_out_token") or 0),
        "actual_transfer_net_token": float(row.get("actual_transfer_net_token") or 0),
        "pool_transfer_event_count": int(row.get("pool_transfer_event_count") or 0),
